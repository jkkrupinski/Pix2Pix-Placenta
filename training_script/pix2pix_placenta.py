# -*- coding: utf-8 -*-
"""pix2pix_placenta.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SrwqKmYHMpRaBLbilSmDllSygKe2uViJ
...
! kaggle datasets download -d jakubkrupinski/FetReg
! unzip "FetReg.zip"
...
sample_path = PATH + 'train/labels/Video001_frame00500.png'
...
def load(image_file):
  ...
  real_image = tf.io.read_file(PATH + splt[1] +'/images/'+splt[3])
...
inp, re = load(str(PATH + 'train/labels/Video001_frame00500.png'))
...
train_dataset = tf.data.Dataset.list_files(str(PATH + 'train/labels/*.png'))
train_dataset = train_dataset.map(load_image_train,
                                  num_parallel_calls=tf.data.AUTOTUNE)
train_dataset = train_dataset.shuffle(BUFFER_SIZE)
train_dataset = train_dataset.batch(BATCH_SIZE)

test_dataset = tf.data.Dataset.list_files(str(PATH + 'test/labels/*.png'))
...
# !zip -r 'model.zip' 'saved_model/model'

from google.colab import files
files.download("model.zip")

# files.download("saved_modell/model.h5")

! mkdir saved_modell
generator.save('saved_modell/model', save_format='h5')